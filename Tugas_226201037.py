...
while True: 
    ...
    if cv2.waitKey(1)==ord('h'):  #Menunggu 1 milidetik untuk menekan tombol pada jendela video. Jika menekan tombol 'q', maka akan terjadi proses keluar dari loop dan menghentikan program/kamera video
        break
